...
const CategoriesPage = () => {
  ...
  return (
    <section
      className={`mb-6 mt-2 w-full lg:mt-0 ${isActiveFestival ? "mb-4 translate-y-10 transition-transform duration-200 ease-linear" : "mb-0 translate-y-0 transition-transform duration-200 ease-linear"}`}
    >
